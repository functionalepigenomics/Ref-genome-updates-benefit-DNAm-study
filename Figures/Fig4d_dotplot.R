setwd("~/KoborLab/kobor_space/zdong/T2T/Array-based/EWAS_cancer/Figure/Cancer-driver")
...
ggsave("Enrichmen_cancer_driver_array_T2T.pdf",p, width=2.8, height=6)